# app/observability/ — dependency-free metrics + structured logging
...
metric definitions wired into central record points, and a backend-only live resource poller. What a metric
*means* / when to act on it lives in `knowledge/observability.md`.
...
- `resource_poller.py` (`resource_stats_poller`).
