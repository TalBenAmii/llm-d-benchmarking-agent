...
class ExecuteInput(BaseModel):
    ...
    flags: dict[str, Any] | None = Field(
        ...
        description="Optional: {skip, skip_smoketest, dry_run, list_endpoints, methods, repo_path, "
                    ...
                    "step, dataset, stack, parallel, wait_timeout, data_access_timeout, "
                    ...
                    "knowledge-driven (read_knowledge('dataset_replay')). `stack` is a comma-separated "
                    ...
                    "(read_knowledge('multi_stack')). The per-phase CLI TIMEOUT "
