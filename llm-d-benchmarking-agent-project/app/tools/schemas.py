...
class ExecuteInput(BaseModel):
    ...
    flags: dict[str, Any] | None = Field(
        ...
        description="Optional: {skip, skip_smoketest, dry_run, list_endpoints, methods, output, "
                    ...
                    "(knowledge/collect_only.md). `cluster_url`/`cluster_token` (Phase 29) target a "
                    "remote cluster by its API-server URL + bearer token (an alternative to the "
                    "`kubeconfig` file above). They are carried BACKEND-ONLY as the "
