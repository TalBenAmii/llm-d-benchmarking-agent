...
class ExecuteInput(BaseModel):
    ...
    flags: dict[str, Any] | None = Field(
        ...
        description="Optional: {skip, skip_smoketest, dry_run, list_endpoints, methods, repo_path, "
                    ...
                    "step, dataset, analyze, stack, parallel, wait_timeout, data_access_timeout, "
                    ...
                    "(read_knowledge('runconfig_roundtrip')). For subcommand='experiment' "
                    "(a DoE sweep over a "
