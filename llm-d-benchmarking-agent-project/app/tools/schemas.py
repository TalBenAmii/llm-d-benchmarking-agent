...
class ExecuteInput(BaseModel):
    ...
    flags: dict[str, Any] | None = Field(
        ...
        description="Optional: {skip, skip_smoketest, dry_run, list_endpoints, methods, repo_path, "
                    ...
                    "step, dataset, wait_timeout, data_access_timeout, standalone_deploy_timeout, "
                    "gateway_deploy_timeout, modelservice_deploy_timeout, kustomize_deploy_timeout, "
                    "pvc_bind_timeout, fma_teardown_timeout}. "
                    ...
                    "knowledge-driven (read_knowledge('dataset_replay')). The per-phase CLI TIMEOUT "
                    ...
                    "to keep the CLI's own defaults. For subcommand='experiment' "
                    "(a DoE sweep over a "
