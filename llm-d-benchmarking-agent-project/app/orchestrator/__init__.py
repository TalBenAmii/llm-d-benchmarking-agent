...
through the allowlisted ``kubectl`` runner (see :mod:`app.orchestrator.kube`) — never the
Python kubernetes client, which would bypass the deny-by-default allowlist + approval gate.
