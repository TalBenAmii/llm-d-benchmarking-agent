...
> deploy** with least-privilege RBAC. The agent now exposes **35 tools**, and the full
...
has since grown to **35 tools**; see [`FEATURES.md`](FEATURES.md) for the authoritative,
