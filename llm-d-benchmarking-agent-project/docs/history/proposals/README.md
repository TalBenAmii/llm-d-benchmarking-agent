...
| 2 | [02-chaos-resilience.md](02-chaos-resilience.md) | Opt-in fault-injection (KubeClient decorator) + orchestrator-restart durability proof + resilience report. | shipped: `run_resilience_drill` tool (`CHAOS_ENABLED`) + `app/orchestrator/chaos.py` |
