...
- **Design rationale + MVP implementation-status record →** `plan.md`.
...
docs: `README.md`, `FEATURES.md`, `plan.md`, `ROADMAP_V4.md`, `knowledge/`). Not repeated here.
Items the index doesn't list:
- `llm-d-benchmarking-agent-proposal.md` — the original proposal / requirements (the "north star").
