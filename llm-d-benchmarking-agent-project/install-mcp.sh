...
# there is no network/remote mode. See app/mcp/README.md for the security model and manual config.
set -euo pipefail
...
log "own tool-permission prompt. Full details: app/mcp/README.md"
trap - EXIT
