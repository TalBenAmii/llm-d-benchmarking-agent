...
> agent exposes **22 tools**. The headline supported path remains the `llm-d-benchmark`
...
| [docs/API.md](docs/API.md) | The HTTP/WebSocket API + the 22-tool agent surface + the `SessionPlan` |
